...
# 2. تهيئة مخزن البيانات (نفس الكود الأصلي)
if 'project_data' not in st.session_state:
    st.session_state.project_data = [] 
if 'page' not in st.session_state:
    st.session_state.page = 'main_menu' # البداية من القائمة الرئيسية
...
# ==========================================
    ...
    if submit:
        if W > 0 and H > 0:
            ...
            # --- أساسيات التخصيم (نفس كودك بالظبط) ---
...
# ==========================================
# الصفحة الثانية: الاستهلاك والفاتورة (نفس كودك بالظبط)
# ==========================================
elif st.session_state.page == 'inventory':
    st.markdown("<h1>📊 استهلاك خامات المشروع</h1>")
    if st.button("🏠 العودة للرئيسية"):
        st.session_state.page = 'main_menu'
        st.rerun()

...
class AluminumMasterApp(QWidget):
    ...
    def initUI(self):
        ...
        header_label.setStyleSheet("""
            background-color: #2f3640; color: #fbc531; font-size: 22pt; 
        ...
        # منطقة المدخلات
        input_group = QGroupBox("📝 مدخلات المواصفات الفنية")
        input_group.setStyleSheet("QGroupBox { font-weight: bold; border: 2px solid #bdc3c7; border-radius: 10px; margin-top: 10px; padding-top: 15px; }")
        grid = QGridLayout()
    ...
    def save_project_report(self):
        ...
        if file_path:
            try:
                ...
                content += f"📊 [2] إجمالي جرد الخامات:\n- ألومنيوم مفرد: {m/600:.2f} عود\n- ألومنيوم متقارب: {t/600:.2f} عود\n- فيبر: {f/36400:.2f} لوح\n"

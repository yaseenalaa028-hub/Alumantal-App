...
# ==========================================
    ...
    with st.form("main_form", clear_on_submit=True):
        ...
        W = st.number_input("العرض الكلي (W)", min_value=0, step=0.1, format="%.1f")
        H = st.number_input("الارتفاع الكلي (H)", min_value=0, step=0.1, format="%.1f")
        D = st.number_input("العمق الكلي (D)", min_value=0, step=0.1, format="%.1f")

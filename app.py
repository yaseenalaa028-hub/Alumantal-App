...
st.markdown("""
    ...
    .bill-card { background-color: #ffffff; padding: 15px; border-radius: 10px; border-right: 8px solid #fbc531; box-shadow: 0 4px 6px rgba(0,0,0,0.1); margin-bottom: 15px; }
...
# --- صفحة إدخال البيانات ---
    ...
    # --- هنا تظهر التفاصيل الكاملة والخامات ---
        ...
        for u in st.session_state.storage:
            with st.container():
                ...
                <div class="bill-card">
                    ...
                    <p>• <b>الارتفاع:</b> {u['h_baky']} سم (عدد 2 مفرد + 2 متقارب)</p>
                    <p>• <b>العرض:</b> {u['w_baky']} سم (عدد 3 مفرد + 1 متقارب)</p>
                    <p>• <b>العمق:</b> {u['d_baky']} سم (عدد 2 مفرد + 2 متقارب)</p>
    ...
    if st.button("🔄 مسح البيانات وبدء جديد"):
        st.session_state.storage = []
        st.rerun()

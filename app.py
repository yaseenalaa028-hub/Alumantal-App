...
# 1. إعدادات الصفحة والستايل (CSS) لضمان وضوح الأرقام والعناوين
st.set_page_config(page_title="DOGGA SYSTEM | م/ ياسين علاء", layout="wide")

st.markdown("""
    <style>
    /* تنسيق الجداول: خط كبير وعريض */
    .stTable td { 
    ...
    /* تنسيق العناوين الفرعية للجداول */
    .table-header {
...
# --- صفحة التطبيق الرئيسي ---
    ...
    for idx, item in enumerate(st.session_state.project_list):
        ...
        # إضافة العنوان التلقائي للنوع فوق الجدول
